...
export default function HeaderTop({ handleScroll }) {
  return (
    <div className="bg-gradient-to-b from-blue-400 via-blue-300 to-sky-200 text-white shadow-lg">
      ...
      {/* Top Contact Bar - Light Blue Theme */}
...
<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 md:py-8">
  <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
    ...
    <div className="flex flex-col items-center md:items-start text-center md:text-left">
      ...
      <div className="mt-2">
        <h2 className="text-xl xs:text-2xl sm:text-2.5xl md:text-3xl lg:text-4xl font-extrabold tracking-tight leading-tight text-blue-950">
    ...
    {/* Swachh Bharat Image - Hidden on small screens */}
